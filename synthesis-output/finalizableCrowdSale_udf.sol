...
/**
 * UDF base contract for the finalizableCrowdSale benchmark.
 *
 ...
 */
contract FinalizableCrowdsaleUDF {
    // Exchange rate: number of token units a buyer gets per wei.
    // Corresponds to the `rate` variable in the original FinalizableCrowdsale contract.
