contract Tether {
  ...
  function updateRedeemOnInsertRecv_redeem_r18(address p,int amount) private   returns (bool) {
  ...
  function updateIssueOnInsertRecv_issue_r22(address p,int amount) private   returns (bool) {
      address s = msg.sender;
      address o = owner.p;
      if(o==s && n>0) {
