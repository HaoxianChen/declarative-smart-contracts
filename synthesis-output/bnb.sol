contract Bnb {
  ...
  function freeze(address p,int n) public    {
      bool r15 = updateFreezeOnInsertRecv_freeze_r15(p,n);
      if(r15==false) {
        revert("Rule condition failed");
      }
  }
  ...
  function updateTransferFromOnInsertRecv_transferFrom_r6(address from,address to,address spender,int amount) private   returns (bool) {
  ...
  function updateFreezeOfOnIncrementTotalUnfreeze_r16(address p,int u) private    {
      int delta0 = int(-u);
      updateBalanceOfOnIncrementFreezeOf_r1(p,delta0);
  }
  function updateBurnOnInsertRecv_burn_r5(address p,int amount) private   returns (bool) {
      address s = msg.sender;
      address o = owner.p;
  ...
  function updateFreezeOnInsertRecv_freeze_r15(address p,int n) private   returns (bool) {
      int balanceOf_x1 = balanceOf[p].n;
      if(n<=balanceOf_x1) {
  ...
  function updateTotalUnfreezeOnInsertUnfreeze_r14(address p,int n) private    {
      int delta0 = int(n);
      updateFreezeOfOnIncrementTotalUnfreeze_r16(p,delta0);
  }
  ...
  function updateFreezeOfOnIncrementTotalFreeze_r16(address p,int f) private    {
      int delta0 = int(f);
      updateBalanceOfOnIncrementFreezeOf_r1(p,delta0);
  }
  ...
  function updateTotalFreezeOnInsertFreeze_r24(address p,int n) private    {
      int delta0 = int(n);
      updateFreezeOfOnIncrementTotalFreeze_r16(p,delta0);
  }
