contract Erc1155 {
  ...
  function updateTransferFromOnInsertRecv_transferFrom_r7(int tokenId,address from,address to,address spender,int amount) private   returns (bool) {
  ...
  function updateBurnOnInsertRecv_burn_r26(int tokenId,address p,int amount) private   returns (bool) {
  ...
  function updateMintOnInsertRecv_mint_r12(int tokenId,address p,int amount) private   returns (bool) {
      address s_1 = msg.sender;
      address o_1 = owner.p;
  ...
  function updateIncreaseAllowanceOnInsertRecv_increaseAllowance_r23(int tokenId,address o,address s,int d) private   returns (bool) {
  ...
  function updateTransferOnInsertRecv_transfer_r4(int tokenId,address from,address to,int amount) private   returns (bool) {
