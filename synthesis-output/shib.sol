contract Shib {
  ...
  function transfer(address s,address r,int n) public    {
      bool r7 = updateTransferOnInsertRecv_transfer_r7(s,r,n);
      if(r7==false) {
        revert("Rule condition failed");
      }
  }
  ...
  function updateBurnFromOnInsertRecv_burnFrom_r16(address s,address p,int n) private   returns (bool) {
      ...
      if(n<=balanceOf_x1) {
        updateBurnOnInsertBurnFrom_r4(p,n);
        updateTransferFromOnInsertBurnFrom_r6(s,p,n);
        emit BurnFrom(s,p,n);
        return true;
      }
      return false;
  ...
  function updateTransferFromOnInsertBurnFrom_r6(address s,address p,int n) private    {
      ...
      updateSpentTotalOnInsertTransferFrom_r13(s,address(0),n);
