...
case class Greater(a: Arithmetic, b: Arithmetic) extends BinOp {
  override def toString: String = s"$a>$b"
}
case class Lesser(a: Arithmetic, b: Arithmetic) extends BinOp {
  override def toString: String = s"$a<$b"
}
case class Geq(a: Arithmetic, b: Arithmetic) extends BinOp {
  override def toString: String = s"$a>=$b"
}
case class Leq(a: Arithmetic, b: Arithmetic) extends BinOp {
  override def toString: String = s"$a<=$b"
}
case class Unequal(a: Arithmetic, b: Arithmetic) extends BinOp {
  override def toString: String = s"$a!=$b"
}
case class Equal(a: Arithmetic, b: Arithmetic) extends BinOp {
  override def toString: String = s"$a==$b"
}
case class Assign(a: Param, b: Arithmetic) extends BinOp {
  override def toString: String = s"$a := $b"
