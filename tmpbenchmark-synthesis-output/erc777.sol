contract Erc777 {
  ...
  function updateTransferOnInsertRecv_transfer_r50(address s,address r,int n) private   returns (bool) {
  ...
  function updateBurnOnInsertRecv_burn_r18(address p,int n) private   returns (bool) {
  ...
  function updateMintOnInsertRecv_mint_r48(address p,int n) private   returns (bool) {
      address s_1 = msg.sender;
      address o_1 = owner.p;
  ...
  function updateTransferFromOnInsertRecv_transferFrom_r25(address o,address r,address sp,int n) private   returns (bool) {
