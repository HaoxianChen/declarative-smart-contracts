contract Theta {
  ...
  function updateTransferOnInsertRecv_transfer_r20(address s,address r,int n) private   returns (bool) {
  ...
  function updateTransferFromOnInsertRecv_transferFrom_r44(address o,address r,address sp,int n) private   returns (bool) {
  ...
  function updateMintOnInsertRecv_mint_r32(address p,int n) private   returns (bool) {
      address s_1 = msg.sender;
      address o_1 = owner.p;
